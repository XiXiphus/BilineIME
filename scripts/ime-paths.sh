...
SETTINGS_DEV_BUNDLE_ID="io.github.xixiphus.inputmethod.BilineIME.settings.dev"
SETTINGS_DEV_PRODUCT_NAME="BilineSettingsDev"
SETTINGS_DEV_EXECUTABLE="BilineSettingsDev"
SETTINGS_DEV_INSTALL_ROOT="$HOME/Applications"
SETTINGS_DEV_INSTALL_PATH="$SETTINGS_DEV_INSTALL_ROOT/$SETTINGS_DEV_PRODUCT_NAME.app"
SETTINGS_DEV_BUILD_APP_PATH="$DERIVED_DATA/Build/Products/Debug/$SETTINGS_DEV_PRODUCT_NAME.app"
LEGACY_SETTINGS_DEV_BUILD_PATH="$HOME/Library/Caches/BilineIME/SettingsDerivedData/Build/Products/Debug/$SETTINGS_DEV_PRODUCT_NAME.app"
...
STALE_SETTINGS_DEV_PATHS=(
  "$SETTINGS_DEV_BUILD_APP_PATH"
  "$LEGACY_SETTINGS_DEV_BUILD_PATH"
)
